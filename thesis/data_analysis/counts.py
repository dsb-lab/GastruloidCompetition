...
for stage in stages:
    ...
    for TIME in TIMES:
        F3_WT[-1].append([])
        A12_WT[-1].append([])
        Casp3_F3_WT[-1].append([])
        Casp3_A12_WT[-1].append([])

        F3_KO[-1].append([])
        A12_KO[-1].append([])
        Casp3_F3_KO[-1].append([])
        Casp3_A12_KO[-1].append([])
    ...
    for exp, experiment in enumerate(experiments):
        for T, TIME in enumerate(TIMES):
            ...
            for COND in CONDS:
                ...
                if COND == "WT":
                    F3_WT[-1][T] = [*F3_WT[-1][T], *F3_counts]
                    A12_WT[-1][T] = [*A12_WT[-1][T], *A12_counts]
                    Casp3_F3_WT[-1][T] = [*Casp3_F3_WT[-1][T], *Casp3_F3_counts]
                    Casp3_A12_WT[-1][T] = [*Casp3_A12_WT[-1][T], *Casp3_A12_counts]
                elif COND == "KO":
                    F3_KO[-1][T] = [*F3_KO[-1][T], *F3_counts]
                    A12_KO[-1][T] = [*A12_KO[-1][T], *A12_counts]
                    Casp3_F3_KO[-1][T] = [*Casp3_F3_KO[-1][T], *Casp3_F3_counts]
                    Casp3_A12_KO[-1][T] = [*Casp3_A12_KO[-1][T], *Casp3_A12_counts]
