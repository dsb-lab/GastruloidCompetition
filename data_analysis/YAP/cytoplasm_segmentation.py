...
for COND in CONDITIONS:
    ...
    path_save_dir = "/home/pablo/Desktop/PhD/projects/Data/gastruloids/joshi/YAP/segmentation_results/{}/".format(COND)
    ...
    for file in files:
        ...
        path_save_dir_quant = "/home/pablo/Desktop/PhD/projects/Data/gastruloids/joshi/YAP/quantifications/{}/{}_F3.csv".format(COND, fname)
        ...
        path_save_dir_quant = "/home/pablo/Desktop/PhD/projects/Data/gastruloids/joshi/YAP/quantifications/{}/{}_A12.csv".format(COND, fname)
        df.to_csv(path_save_dir_quant, index=False)
...
ax.legend()
plt.savefig("/home/pablo/Desktop/PhD/projects/Data/gastruloids/joshi/YAP/quantifications/F3.svg")
plt.show()
...
path_save_dir_quant = "/home/pablo/Desktop/PhD/projects/Data/gastruloids/joshi/YAP/quantifications/WT/F3.csv"
df.to_csv(path_save_dir_quant, index=False)
...
df = pd.DataFrame(data, columns=col_names)
path_save_dir_quant = "/home/pablo/Desktop/PhD/projects/Data/gastruloids/joshi/YAP/quantifications/KO8/F3.csv"
df.to_csv(path_save_dir_quant, index=False)
...
ax.set_xlabel("N/C YAP")
ax.legend()
plt.savefig("/home/pablo/Desktop/PhD/projects/Data/gastruloids/joshi/YAP/quantifications/A12.svg")
plt.show()
...
df = pd.DataFrame(data, columns=col_names)
path_save_dir_quant = "/home/pablo/Desktop/PhD/projects/Data/gastruloids/joshi/YAP/quantifications/WT/A12.csv"
df.to_csv(path_save_dir_quant, index=False)
...
df = pd.DataFrame(data, columns=col_names)
path_save_dir_quant = "/home/pablo/Desktop/PhD/projects/Data/gastruloids/joshi/YAP/quantifications/KO8/A12.csv"
df.to_csv(path_save_dir_quant, index=False)
...
df = pd.DataFrame(data, columns=col_names)
path_save_dir_quant = "/home/pablo/Desktop/PhD/projects/Data/gastruloids/joshi/YAP/quantifications/KO25/A12.csv"
df.to_csv(path_save_dir_quant, index=False)