...
CT_cyto.load()
CT_cyto.plot_tracking(plot_args)
...
CT_nuc.load()
CT_nuc.plot_tracking(plot_args)
...
ax.legend()
plt.savefig("/home/pablo/Desktop/PhD/projects/GastruloidCompetition/results/YAP/segmentation_examples/cyto_quantification.svg")
plt.show()
...
ax.legend()
plt.tight_layout()
plt.savefig("/home/pablo/Desktop/PhD/projects/GastruloidCompetition/results/YAP/segmentation_examples/cytoplasm.svg", dpi=300)
plt.savefig("/home/pablo/Desktop/PhD/projects/GastruloidCompetition/results/YAP/segmentation_examples/cytoplasm.png", dpi=300)
plt.show()
