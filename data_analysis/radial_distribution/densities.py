...
path_figures = "/home/pablo/Desktop/PhD/projects/GastruloidCompetition/thesis/figures/density/"
...
for number_of_neighs in [5 ,10, 15, 20, 30, 50, 75, 100, 200]:
    ...
    plt.tight_layout()
    plt.savefig(path_figures+"density_{}.svg".format(number_of_neighs))
    plt.savefig(path_figures+"density_{}.pdf".format(number_of_neighs))
