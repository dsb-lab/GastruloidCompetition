    ...
    for COND in CONDS:
        ...
        for f, file in enumerate(files):
            ...
            for cell in CT_Casp3.jitcells:
                ...
                area = len(msk) * CT_Casp3.CT_info.xyresolution**2
                if area > 33.34:
                    cells_remove.append(cell.label)

            for lab in np.unique(cells_remove):
            ...
            for cell in CT_Casp3.jitcells:
                ...
                mask = cell.masks[0][zid]
                outline = cell.outlines[0][zid]
                casp3 = np.mean(CT_Casp3.hyperstack[0,z,ch_Casp3,:,:][mask[:,1], mask[:,0]])
                if casp3 < casp3_th:
                    cells_remove.append(cell.label)
