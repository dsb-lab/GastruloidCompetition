...
for C, COND in enumerate(CONDS):
    ...
    for f, file in enumerate(files):
        ...
        for cell in CT_F3.jitcells:
            ...
            f3.append(np.mean(CT_A12.hyperstack[0,z,ch_p53,:,:][mask[:,1], mask[:,0]]) - F3_backgrounds[z])
        ...
        for cell in CT_A12.jitcells:
            ...
            zid = cell.zs[0].index(z)
            mask = cell.masks[0][zid]
            a12.append(np.mean(CT_A12.hyperstack[0,z,ch_p53,:,:][mask[:,1], mask[:,0]]) - A12_backgrounds[z])
