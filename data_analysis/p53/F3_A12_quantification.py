...
ax.plot(range(10), F3_means, color=[0.0,0.8,0.0, 1.0], label="Mean")
ax.fill_between(range(10), F3_means - F3_stds, F3_means + F3_stds, color=[0.0,0.8,0.0], alpha=0.2, label="±1 std")

ax.plot(range(10), A12_means, color=[0.8,0.0,0.8, 1.0], label="Mean")
ax.fill_between(range(10), A12_means - A12_stds, A12_means + A12_stds, color=[0.8,0.0,0.8], alpha=0.2, label="±1 std")
